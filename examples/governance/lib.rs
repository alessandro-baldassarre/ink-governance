...
pub mod my_access_control {
    use ink_governance::governor::{
        governor,
        modules::{governor_counting_simple::*, governor_votes_members},
    };
    use openbrush::{contracts::access_control::extensions::enumerable::*, traits::Storage};
    ...
    pub struct Contract {
        ...
        #[storage_field]
        governor: governor::Data<Counting, governor_votes_members::Voting>,
    }
